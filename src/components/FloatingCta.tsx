    ...
    >
      ...
      >
        <div className="flex flex-col text-left">
          <span className="font-sora font-bold uppercase text-xs sm:text-sm text-white tracking-wider leading-tight">
            Garantir minha vaga
          </span>
          <span className="text-[10px] sm:text-[11px] text-[#00E5FF] font-medium uppercase tracking-wider leading-tight">
            Conecta Summit 2026
          </span>
        </div>
